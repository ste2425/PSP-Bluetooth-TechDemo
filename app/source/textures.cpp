...
extern unsigned char ic_fso_type_app_png_start[], ic_fso_type_compress_png_start[], ic_fso_type_audio_png_start[], 
    ...
    dualsense_dark_png_start[], dualsense_png_start[], switch_png_start[], switch_dark_png_start[];
...
extern unsigned int ic_fso_type_app_png_size, ic_fso_type_compress_png_size, ic_fso_type_audio_png_size, ic_fso_folder_png_size, 
    ...
    dualsense_dark_png_size, dualsense_png_size, switch_png_size, switch_dark_png_size;
...
g2dTexture *file_icons[NUM_FILE_ICONS], *icon_dir[NUM_THEMES], *icon_check[NUM_THEMES], *icon_uncheck[NUM_THEMES], \
    ...
    *dualsense_icon[NUM_THEMES], *switch_icon[NUM_THEMES];
...
namespace Textures {
    ...
    void Load(void) {
        ...
        // TODO fix this
        dualsense_icon[1] = Textures::LoadImageBufferPNG(dualsense_png_start, dualsense_png_size); //light
        dualsense_icon[0] = Textures::LoadImageBufferPNG(dualsense_dark_png_start, dualsense_dark_png_size); //dark
    
        switch_icon[1] = Textures::LoadImageBufferPNG(switch_png_start, switch_png_size); //light
        switch_icon[0] = Textures::LoadImageBufferPNG(switch_dark_png_start, switch_dark_png_size); //dark
    ...
    void Free(void) {
        ...
        for (int i = 0; i < NUM_THEMES; i++) {
            ...
            g2dTexFree(&dualsense_icon[i]);
            g2dTexFree(&switch_icon[i]);
        }
